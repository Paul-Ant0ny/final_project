"""
Django settings for realestate_management project.
...
SECRET_KEY = 'django-insecure-*w=j&tl$#p=kfi^pxm7(!q%cqyu)=*w*d(-gw)st%frcm8hx=s'
...
ROOT_URLCONF = 'realestate_management.urls'
...
WSGI_APPLICATION = 'realestate_management.wsgi.application'
